...
public class PropertyValues {
    ...
    public void addPropertyValue(String propertyName, Object propertyValue, String type, boolean isRef) {
        addPropertyValue(new PropertyValue(propertyName, propertyValue, type, isRef));
    }
